defmodule TodoappWeb.TaskControllerTest do
  ...
  @create_attrs %{description: "some description", points: 42, status: "some status", title: "some title"}
  @update_attrs %{description: "some updated description", points: 43, status: "some updated status", title: "some updated title"}
  @invalid_attrs %{description: nil, points: nil, status: nil, title: nil}

  def fixture(:task) do
    {:ok, task} = Project.create_task(@create_attrs)
    task
  end
